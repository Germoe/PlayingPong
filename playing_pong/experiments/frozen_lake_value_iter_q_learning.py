...
class Agent:
    ...
    def calc_action_value(self, state, action):
        ...
        for target_s, count in target_counts.items():
            ...
            best_action = self.select_action(target_s)  # equivalent to argmax_a Q(s',a)
            val = reward + GAMMA * self.qs[(target_s, best_action)]
            q_sa += count / total * val
        return q_sa
